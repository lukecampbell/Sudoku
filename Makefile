...
LIBS=
OBJECTS=Sudoku.o Square.o tools.o Board.o Cluster.o Tests.o SquareState.o Game.o BadMove.o IllegalInput.o ConflictingValue.o FatalException.o DiagBoard.o
